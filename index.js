...
async function startBot() {
    ...
    conn.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./control")(conn, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
    ...
    if (!crizzyy.setting.anticall) return
    console.log(fadhil)
    ...
    conn.sendContact = async (jid, owner, quoted = '', opts = {}) => {
	    	let list = []
for (let i of owner) {
list.push({
...
END:VCARD`
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        let reason = new Boom(lastDisconnect?.error)?.output.statusCode
            ...
            else if (reason === DisconnectReason.Multidevicemismatch) { console.log("Multi device mismatch, please scan again"); conn.logout(); }
